...
public class DaoUsuario {
    ...
    public boolean registrar(Usuario u, String codigoVerificacion) {

        String sql = "INSERT INTO usuario(nombre,apPaterno,apMaterno,correo,password,estado,verificado,codigoVerificacion) "
                + "VALUES(?,?,?,?,?,'activo',0,?)";
        ...
        try (Connection con = ConexionMySQL.getConnection();
            ...
            ps.setString(6, codigoVerificacion);
    ...
    public boolean actualizarCodigo(String correo, String codigoVerificacion) {

        String sql = "UPDATE usuario SET codigoVerificacion=? WHERE correo=? AND verificado=0";
        ...
        try (Connection con = ConexionMySQL.getConnection();
            ...
            ultimoError = "Error al ACTUALIZAR CODIGO: " + e.getMessage();
            e.printStackTrace();
    ...
    public boolean verificarCodigo(String correo, String codigo) {
        ...
        String sql = "UPDATE usuario SET verificado=1, codigoVerificacion=NULL "
                + "WHERE correo=? AND codigoVerificacion=? AND verificado=0";
        ...
        try (Connection con = ConexionMySQL.getConnection();
            ...
            ultimoError = "Error al VERIFICAR: " + e.getMessage();
            e.printStackTrace();
    ...
    // Para el Login: revisa correo + password + que la cuenta este activa.
    // OJO: NO filtra por "verificado" aqui a proposito, para poder avisarle
    // al usuario "tu cuenta no esta verificada" en vez de un generico
